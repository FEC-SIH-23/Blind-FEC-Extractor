...
def create_trt_resource_handle(resource_name: str, name=None) -> Annotated[Any, _atypes.Resource]:
  r"""TODO: add doc.
...
def create_trt_resource_handle_eager_fallback(resource_name: str, name, ctx) -> Annotated[Any, _atypes.Resource]:
  resource_name = _execute.make_str(resource_name, "resource_name")
  _inputs_flat = []
...
def get_calibration_data_op(resource_name: Annotated[Any, _atypes.String], name=None) -> Annotated[Any, _atypes.String]:
...
def get_calibration_data_op_eager_fallback(resource_name: Annotated[Any, _atypes.String], name, ctx) -> Annotated[Any, _atypes.String]:
...
def initialize_trt_resource(resource_handle: Annotated[Any, _atypes.Resource], filename: Annotated[Any, _atypes.String], max_cached_engines_count:int=1, name=None):
  r"""TODO: add doc.
...
def initialize_trt_resource_eager_fallback(resource_handle: Annotated[Any, _atypes.Resource], filename: Annotated[Any, _atypes.String], max_cached_engines_count: int, name, ctx):
  if max_cached_engines_count is None:
    max_cached_engines_count = 1
  max_cached_engines_count = _execute.make_int(max_cached_engines_count, "max_cached_engines_count")
...
def serialize_trt_resource(resource_name: Annotated[Any, _atypes.String], filename: Annotated[Any, _atypes.String], delete_resource:bool=False, save_gpu_specific_engines:bool=True, name=None):
  r"""TODO: add doc.
...
def serialize_trt_resource_eager_fallback(resource_name: Annotated[Any, _atypes.String], filename: Annotated[Any, _atypes.String], delete_resource: bool, save_gpu_specific_engines: bool, name, ctx):
  if delete_resource is None:
    delete_resource = False
  delete_resource = _execute.make_bool(delete_resource, "delete_resource")
  if save_gpu_specific_engines is None:
...
def trt_engine_op(in_tensor, serialized_segment: str, OutT, workspace_size_bytes: int, precision_mode: str, segment_func="", input_shapes=[], output_shapes=[], max_cached_engines_count:int=1, max_batch_size:int=1, calibration_data:str="", use_calibration:bool=True, segment_funcdef_name:str="", cached_engine_batches=[], fixed_input_size:bool=True, static_engine:bool=True, profile_strategy:str="", use_explicit_precision:bool=False, name=None):
  r"""TODO: add doc.
...
def trt_engine_op_eager_fallback(in_tensor, serialized_segment: str, OutT, workspace_size_bytes: int, precision_mode: str, segment_func, input_shapes, output_shapes, max_cached_engines_count: int, max_batch_size: int, calibration_data: str, use_calibration: bool, segment_funcdef_name: str, cached_engine_batches, fixed_input_size: bool, static_engine: bool, profile_strategy: str, use_explicit_precision: bool, name, ctx):
  serialized_segment = _execute.make_str(serialized_segment, "serialized_segment")
  if not isinstance(OutT, (list, tuple)):
    raise TypeError(
        "Expected list for 'OutT' argument to "
